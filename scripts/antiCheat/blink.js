    ...
    if (
      ...
      if (speed > 0) {
        if (player.lastBlinkSpeed == speed) {
          if (
            Math.abs(player.lastAction3?.location?.x - player.location.x) < 0.001 &&
            Math.abs(player.lastAction3?.location?.y - player.location.y) < 0.001 &&
            Math.abs(player.lastAction3?.location?.z - player.location.z) < 0.001
          ) {
